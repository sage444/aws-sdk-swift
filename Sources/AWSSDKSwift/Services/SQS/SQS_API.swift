...
public struct SQS {
    ...
    public init(accessKeyId: String? = nil, secretAccessKey: String? = nil, region: AWSSDKSwiftCore.Region? = nil, endpoint: String? = nil) {
        self.client = AWSClient(
            ...
            endpoint: endpoint,
            serviceEndpoints: ["fips-us-east-2": "sqs-fips.us-east-2.amazonaws.com", "fips-us-east-1": "sqs-fips.us-east-1.amazonaws.com", "fips-us-west-2": "sqs-fips.us-west-2.amazonaws.com", "fips-us-west-1": "sqs-fips.us-west-1.amazonaws.com"],
            middlewares: [],
